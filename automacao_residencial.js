function AlteraRele1(){
    ...
    if(estado === "0"){
		...
		document.getElementById("botao").innerHTML="<a href='/?L6' class='botao'>Desliga</a>";
    } else {
        document.getElementById("estado").innerHTML="0";
        document.getElementById("rele").innerHTML="<div class='rele1_desligado'></div>";
        document.getElementById("botao").innerHTML="<a href='/?H6' class='botao'>Liga</a>";
    }
}
...
function AlteraRele2(){
    ...
    if(estado_2 === "0"){
		...
		document.getElementById("botao_2").innerHTML="<a href='/?G1' class='botao_2'>Desliga</a>";
    } else {
        document.getElementById("estado_2").innerHTML="0";
        document.getElementById("rele_2").innerHTML="<div class='rele2_desligado'></div>";
        document.getElementById("botao_2").innerHTML="<a href='/?G2' class='botao_2'>Liga</a>";
    }
}
